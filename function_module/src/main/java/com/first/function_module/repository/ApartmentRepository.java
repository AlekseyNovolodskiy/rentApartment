...
public interface ApartmentRepository extends JpaRepository<ApartmentEntity, Long> {
    ...
    List<ApartmentEntity> searchApartmentEntitiesByCostAndAreaAndCountOfPeople(Double cost, Double area, Integer numberOfPeople);

    ApartmentEntity findByCostAndAreaAndCountOfPeople(Double cost, Double area, Integer numberOfPeople);

    List<ApartmentEntity> searchApartmentEntitiesByCountOfPeople(Integer countOfPeople); //sping data generation
...
//   public List<ApartmentEntity> searchApartmentEntitiesWithCountOfPeopleNative(Double countOfPeople); //native query
    ...
    List<ApartmentEntity> searchApartmentEntitiesWithCountOfPeopleJPQL(Integer countOfPeople); //JPQL query

    List<ApartmentEntity> searchApartmentEntitiesByCountOfPeopleAndArea(Integer countOfPeople, Double area);

    List<ApartmentEntity> searchApartmentEntitiesByCountOfPeopleAndCost(Integer countOfPeople, Double cost);
    ...
    @Query( value = "select a from ApartmentEntity a  where a.id = :id")
